...
export const EXPIRY_REQUIRED_TYPES: SellingType[] = [
  ...
  "herbal_tea",
  "herbal_extract",
  "herbal_digestive_care",
  "herbal_liver_care",
  "herbal_respiratory_care",
  "herbal_immunity_boosters",
  "herbal_general_health_tonic",
  "herbal_mens_health",
  "herbal_womens_health",
  "herbal_sexual_wellness",
  "herbal_skin_care",
  "herbal_hair_care",
  "herbal_joint_pain_relief",
  "herbal_diabetes_support",
  "herbal_heart_care",
  "herbal_weight_loss",
  "herbal_weight_gain",
  "herbal_brain_memory",
